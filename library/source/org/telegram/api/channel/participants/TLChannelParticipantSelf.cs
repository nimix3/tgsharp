namespace org.telegram.api.channel.participants
{
    ...
    {
        public const int CLASS_ID = -1557620115;
        private int date;
        ...
        protected TLChannelParticipantSelf(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "channel.participants.TLChannelParticipantSelf#a3289a6d";
    }
}
