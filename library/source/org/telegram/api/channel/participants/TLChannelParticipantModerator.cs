namespace org.telegram.api.channel.participants
{
    ...
    {
        public const int CLASS_ID = -1861910545;
        private int date;
        ...
        protected TLChannelParticipantModerator(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "channel.participants.TLChannelParticipantModerator#91057fef";
    }
}
