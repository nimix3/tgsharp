namespace org.telegram.api.update
{
    ...
    [Serializable]
    public class TLUpdateReadMessagesOutbox : TLAbsUpdate
    {
        public const int CLASS_ID = 0x2f2f21bf;
        private int maxId;
        ...
        protected TLUpdateReadMessagesOutbox(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }

        [MethodImpl(MethodImplOptions.NoInlining), Throws(new string[] { "java.io.IOException" }), LineNumberTable(new byte[] { 0x44, 0x72, 0x6c, 0x6c, 0x6c })]
        ...
        public override string toString() => 
            "updateReadMessageOutbox#2f2f21bf";
    }
}
