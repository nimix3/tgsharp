namespace org.telegram.api.update
{
    ...
    [Serializable]
    public class TLUpdateReadMessagesInbox : TLAbsUpdate
    {
        public const int CLASS_ID = -1721631396;
        private int maxId;
        ...
        protected TLUpdateReadMessagesInbox(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "updateReadMessagesInbox#9961fd5c";
    }
}
