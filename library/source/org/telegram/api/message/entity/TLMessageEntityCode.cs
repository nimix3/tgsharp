namespace org.telegram.api.message.entity
{
    ...
    {
        public const int CLASS_ID = 0x28a20571;
        private int length;
        private int offset;
        ...
        protected TLMessageEntityCode(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "message.entity.MessageEntityCode#28a20571";
    }
}
