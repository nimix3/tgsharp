namespace org.telegram.api.message.entity
{
    ...
    {
        public const int CLASS_ID = -1148011883;
        private int length;
        private int offset;
        ...
        protected TLMessageEntityUnknown(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "message.entity.MessageEntityUnknown#bb92ba95";
    }
}
