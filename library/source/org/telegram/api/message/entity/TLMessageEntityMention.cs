namespace org.telegram.api.message.entity
{
    ...
    {
        public const int CLASS_ID = -100378723;
        private int length;
        private int offset;
        ...
        protected TLMessageEntityMention(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "message.entity.MessageEntityMention#fa04579d";
    }
}
