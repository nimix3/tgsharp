namespace org.telegram.api.message.entity
{
    ...
    {
        public const int CLASS_ID = -1117713463;
        private int length;
        private int offset;
        ...
        protected TLMessageEntityBold(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "message.entity.MessageEntityBold#bd610bc9";
    }
}
