namespace org.telegram.api.message.entity
{
    ...
    {
        public const int CLASS_ID = 0x6cef8ac7;
        private int length;
        private int offset;
        ...
        protected TLMessageEntityBotCommand(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "message.entity.MessageEntityBotCommand#6cef8ac7";
    }
}
