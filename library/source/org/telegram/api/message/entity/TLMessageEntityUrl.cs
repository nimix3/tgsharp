namespace org.telegram.api.message.entity
{
    ...
    {
        public const int CLASS_ID = 0x6ed02538;
        private int length;
        private int offset;
        ...
        protected TLMessageEntityUrl(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "message.entity.MessageEntityUrl#6ed02538";
    }
}
