namespace org.telegram.api.functions.messages
{
    ...
    public class TLRequestMessagesSaveRecentStickers : TLMethod
    {
        public const int CLASS_ID = 0x392718f8;
        ...
        protected TLRequestMessagesSaveRecentStickers(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining), Throws(new string[] { "java.io.IOException" }), LineNumberTable(new byte[] { 0x23, 0x6c, 0x77, 0x6c })]
