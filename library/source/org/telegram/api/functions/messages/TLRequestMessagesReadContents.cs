namespace org.telegram.api.functions.messages
{
    ...
    public class TLRequestMessagesReadContents : TLMethod
    {
        public const int CLASS_ID = 0x36a73f77;
        ...
        protected TLRequestMessagesReadContents(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining), Throws(new string[] { "java.io.IOException" }), LineNumberTable(new byte[] { 6, 0x6d })]
        ...
        public virtual TLAffectedMessages deserializeResponse(InputStream stream, TLContext context)
        {
            ...
            Throwable.__<suppressFillInStackTrace>();
            throw new IOException(new StringBuilder().append("Incorrect response type. Expected org.telegram.tl.messages.TLAffectedMessages, got: ").append(Object.instancehelper_getClass(obj2).getCanonicalName()).toString());
        }
