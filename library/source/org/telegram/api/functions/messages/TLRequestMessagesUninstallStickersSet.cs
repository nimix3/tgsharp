namespace org.telegram.api.functions.messages
{
    ...
    public class TLRequestMessagesUninstallStickersSet : TLMethod
    {
        public const int CLASS_ID = -110209570;
        ...
        protected TLRequestMessagesUninstallStickersSet(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public virtual TLBool deserializeResponse(InputStream stream, TLContext context)
        {
            ...
            Throwable.__<suppressFillInStackTrace>();
            throw new IOException(new StringBuilder().append("Incorrect response type. Expected org.telegram.api.TLBool, got: ").append(Object.instancehelper_getClass(obj2).getCanonicalName()).toString());
        }
        ...
        public override string toString() => 
            "stickers.uninstallStickersSet#f96e55de";
    }
}
