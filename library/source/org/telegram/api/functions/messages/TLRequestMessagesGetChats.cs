namespace org.telegram.api.functions.messages
{
    ...
    public class TLRequestMessagesGetChats : TLMethod
    {
        public const int CLASS_ID = 0x3c6aa187;
        ...
        protected TLRequestMessagesGetChats(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public virtual TLMessagesChats deserializeResponse(InputStream stream, TLContext context)
        {
            ...
            Throwable.__<suppressFillInStackTrace>();
            throw new IOException(new StringBuilder().append("Incorrect response type. Expected ").append(ClassLiteral<TLMessagesChats>.Value.getName()).append(", got: ").append(Object.instancehelper_getClass(obj2).getCanonicalName()).toString());
        }
