namespace org.telegram.api.functions.account
{
    ...
    public class TLRequestAccountUnregisterDevice : TLMethod
    {
        public const int CLASS_ID = 0x65c55b40;
        ...
        protected TLRequestAccountUnregisterDevice(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "account.unregisterDevice#65c55b40";
    }
}
