namespace org.telegram.api.functions.account
{
    ...
    public class TLRequestAccountUpdateUsername : TLMethod
    {
        public const int CLASS_ID = 0x3e0bdd7c;
        ...
        protected TLRequestAccountUpdateUsername(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
