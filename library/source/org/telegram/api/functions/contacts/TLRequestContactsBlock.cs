namespace org.telegram.api.functions.contacts
{
    ...
    public class TLRequestContactsBlock : TLMethod
    {
        public const int CLASS_ID = 0x332b49fc;
        ...
        protected TLRequestContactsBlock(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
