namespace org.telegram.api.functions.auth
{
    ...
    public class TLRequestAuthResetAuthorizations : TLMethod
    {
        public const int CLASS_ID = -1616179942;
        ...
        protected TLRequestAuthResetAuthorizations(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
