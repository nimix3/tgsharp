namespace org.telegram.api.functions.channels
{
    ...
    public class TLRequestChannelsGetMessages : TLMethod
    {
        private TLAbsInputChannel channel;
        public const int CLASS_ID = -1814580409;
        ...
        protected TLRequestChannelsGetMessages(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public virtual TLAbsMessages deserializeResponse(InputStream stream, TLContext context)
        {
            ...
            Throwable.__<suppressFillInStackTrace>();
            throw new IOException(new StringBuilder().append("Incorrect response type. Expected ").append(ClassLiteral<TLAbsMessages>.Value.getName()).append(", got: ").append(Object.instancehelper_getClass(obj2).getName()).toString());
        }
        ...
        public override string toString() => 
            "functions.channels.TLRequestChannelsGetMessages#93d7b347";
    }
}
