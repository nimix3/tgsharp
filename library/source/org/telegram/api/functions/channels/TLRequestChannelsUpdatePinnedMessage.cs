namespace org.telegram.api.functions.channels
{
    ...
    public class TLRequestChannelsUpdatePinnedMessage : TLMethod
    {
        private TLAbsInputChannel channel;
        public const int CLASS_ID = -1490162350;
        private const int FLAG_SILENT = 1;
        private int flags;
        private int id;
        ...
        protected TLRequestChannelsUpdatePinnedMessage(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining), Throws(new string[] { "java.io.IOException" }), LineNumberTable(new byte[] { 0x1a, 0x6c, 0x72, 0x6c })]
        ...
        public override string toString() => 
            "channels.updatePinnedMessage#a72ded52";
    }
}
