namespace org.telegram.api.functions.channels
{
    ...
    public class TLRequestChannelsDeleteUserHistory : TLMethod
    {
        private TLAbsInputChannel channel;
        public const int CLASS_ID = -787622117;
        ...
        protected TLRequestChannelsDeleteUserHistory(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public virtual TLAffectedHistory deserializeResponse(InputStream stream, TLContext context)
        {
            ...
            Throwable.__<suppressFillInStackTrace>();
            throw new IOException(new StringBuilder().append("Incorrect response type. Expected ").append(ClassLiteral<TLAffectedHistory>.Value.getName()).append(", got: ").append(Object.instancehelper_getClass(obj2).getName()).toString());
        }
        ...
        public override string toString() => 
            "functions.channels.TLRequestChannelsDeleteUserHistory#d10dd71b";
    }
}
