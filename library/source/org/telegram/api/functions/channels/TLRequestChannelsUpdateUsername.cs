namespace org.telegram.api.functions.channels
{
    ...
    public class TLRequestChannelsUpdateUsername : TLMethod
    {
        private TLAbsInputChannel channel;
        public const int CLASS_ID = 0x3514b3de;
        ...
        protected TLRequestChannelsUpdateUsername(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "functions.channels.TLRequestChannelsUpdateUsername#3514b3de";
    }
}
