namespace org.telegram.api.functions.channels
{
    ...
    public class TLRequestChannelsLeaveChannel : TLMethod
    {
        private TLAbsInputChannel channel;
        public const int CLASS_ID = -130635115;
        ...
        protected TLRequestChannelsLeaveChannel(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
        ...
        public override string toString() => 
            "functions.channels.TLRequestChannelsLeaveChannel#f836aa95";
    }
}
