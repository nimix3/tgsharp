namespace org.telegram.mtproto.tl
{
    ...
    [Serializable]
    public class MTDestroySessionOk : TLObject
    {
        public const int CLASS_ID = -501201412;
        ...
        protected MTDestroySessionOk(SerializationInfo info1, StreamingContext context1) : base(info1, context1)
        {
        }
